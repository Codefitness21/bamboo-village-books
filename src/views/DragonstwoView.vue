...
<style>
/* Dragons Two Container  */
.dragonstwo-book-container {
  display: flex;
  flex-direction: column;
  justify-content: center;
}

/* Section 1 - Dragons Two Synopsis */
.dragonstwo-synopsis {
  display: flex;
  flex-direction: column;
  justify-content: center;
  background-image: url('https://bamboovillagebooks.s3.us-east-2.amazonaws.com/video/fantasy-d2.gif');
...
@media (max-width: 767px) {
  .dragonstwo .info-container .text-container {
    display: flex;
    flex-direction: column;
    align-items: center;
