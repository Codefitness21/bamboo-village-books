<template>
    <div class="planone-page-container">
      <section class="planone-container">
        <div class="arrow-container">
          <div>
            <a @click="open('services')"><i class="fa-solid fa-angle-left"></i> </a>
          </div>
            ...
            <div class="top-row-container">
              <div class="top-left-container">
                <div>
                  ...
                  <input class="planone-input-field" type="text" id="first name" name="first name" autocomplete="off"/>
                </div>
                <div>
                  <label class="title-input" for="email">Email</label>
                  <input class="planone-input-field" type="text" id="email" name="email" autocomplete="off"/>
                </div>
                <div>
                  <label class="title-input" for="address">Address</label>
                  <input class="planone-input-field" type="text" id="address" name="address" autocomplete="off"/>
                </div>
                <div>
                  <label class="title-input" for="city">City</label>
                  <input class="planone-input-field" type="text" id="city" name="city" autocomplete="off"/>
                </div>
              </div>
              <div class="top-right-container">
                <div>
                  <label class="title-input" for="last name">Last Name</label>
                  <input class="planone-input-field" type="text" id="last name" name="last name" autocomplete="off"/>
                </div>
                <div>
                  <label class="title-input" for="phone">Phone</label>
                  <input class="planone-input-field" type="text" placeholder="(_ _ _) _ _ _ - _ _ _ _" id="phone" name="phone" autocomplete="off"/>
                </div>
                <div>
                  <label class="title-input" for="zip">Zip Code</label>
                  <input class="planone-input-field" type="text" id="zip" name="zip" autocomplete="off"/>
                </div>
                <div>
                  <label class="title-input" for="state">State</label>
                  <input class="planone-input-field" type="text" id="state" name="state" autocomplete="off"/>
                </div>
              </div>
            </div>
